...
export class UniswapV2PairPair__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniswapV2PairPair__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class UniswapV2PairPair extends ethereum.SmartContract {
  static bind(address: Address): UniswapV2PairPair {
    return new UniswapV2PairPair("UniswapV2PairPair", address);
  }
  ...
  burn(to: Address): UniswapV2PairPair__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new UniswapV2PairPair__burnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_burn(to: Address): ethereum.CallResult<UniswapV2PairPair__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new UniswapV2PairPair__burnResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  getReserves(): UniswapV2PairPair__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new UniswapV2PairPair__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<UniswapV2PairPair__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapV2PairPair__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
