...
export class StakedScholarDogeToken__rebasesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class StakedScholarDogeToken extends ethereum.SmartContract {
  static bind(address: Address): StakedScholarDogeToken {
    return new StakedScholarDogeToken("StakedScholarDogeToken", address);
  }
  ...
  rebases(param0: BigInt): StakedScholarDogeToken__rebasesResult {
    let result = super.call(
      "rebases",
    ...
    return new StakedScholarDogeToken__rebasesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_rebases(
    param0: BigInt
  ): ethereum.CallResult<StakedScholarDogeToken__rebasesResult> {
    let result = super.tryCall(
      "rebases",
      "rebases(uint256):(uint256,uint256,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new StakedScholarDogeToken__rebasesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
