...
export class StakedScholarDAOToken__rebasesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class StakedScholarDAOToken extends ethereum.SmartContract {
  static bind(address: Address): StakedScholarDAOToken {
    return new StakedScholarDAOToken("StakedScholarDAOToken", address);
  }
  ...
  rebases(param0: BigInt): StakedScholarDAOToken__rebasesResult {
    let result = super.call(
      "rebases",
    ...
    return new StakedScholarDAOToken__rebasesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_rebases(
    param0: BigInt
  ): ethereum.CallResult<StakedScholarDAOToken__rebasesResult> {
    let result = super.tryCall(
      "rebases",
      "rebases(uint256):(uint256,uint256,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new StakedScholarDAOToken__rebasesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
