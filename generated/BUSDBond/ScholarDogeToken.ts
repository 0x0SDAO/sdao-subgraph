...
export class ScholarDogeToken extends ethereum.SmartContract {
  static bind(address: Address): ScholarDogeToken {
    return new ScholarDogeToken("ScholarDogeToken", address);
  }
