...
export class PancakePairPair__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class PancakePairPair__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class PancakePairPair extends ethereum.SmartContract {
  static bind(address: Address): PancakePairPair {
    return new PancakePairPair("PancakePairPair", address);
  }
  ...
  burn(to: Address): PancakePairPair__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new PancakePairPair__burnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_burn(to: Address): ethereum.CallResult<PancakePairPair__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new PancakePairPair__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getReserves(): PancakePairPair__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new PancakePairPair__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<PancakePairPair__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PancakePairPair__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
